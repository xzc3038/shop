...
class ModelMarketingAffiliate extends Model {
	...
	public function getAffiliate($customer_id) {
		$query = $this->db->query("SELECT DISTINCT *, c.fullname AS customer FROM " . DB_PREFIX . "customer_affiliate ca LEFT JOIN `" . DB_PREFIX . "customer` c ON (ca.customer_id = c.customer_id) WHERE ca.customer_id = '" . (int)$customer_id . "'");
	...
	public function getAffiliates($data = array()) {
		$sql = "SELECT *, c.fullname AS name, ca.status FROM " . DB_PREFIX . "customer_affiliate ca LEFT JOIN " . DB_PREFIX . "customer c ON (ca.customer_id = c.customer_id)";
