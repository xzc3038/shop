...
class ModelExtensionFraudFraudLabsPro extends Model {
	public function check($data) {
		...
		$request['ip'] = $ip;
		$request['first_name'] = get_firstname($data['fullname']);
		$request['last_name'] = get_lastname($data['fullname']);
		...
		if ($data['shipping_method']) {
			$request['ship_first_name'] = get_firstname($data['shipping_fullname']);
			$request['ship_last_name'] = get_lastname($data['shipping_fullname']);
